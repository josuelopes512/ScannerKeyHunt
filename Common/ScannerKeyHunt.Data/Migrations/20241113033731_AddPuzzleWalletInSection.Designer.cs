...
namespace ScannerKeyHunt.Data.Migrations
{
    ...
    [Migration("20241113033731_AddPuzzleWalletInSection")]
    partial class AddPuzzleWalletInSection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScannerKeyHunt.Data.Entities.TokenAuth", b =>
                {
                    ...
                    b.ToTable("TokenAuths");
                });

            modelBuilder.Entity("ScannerKeyHunt.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ScannerKeyHunt.Data.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ScannerKeyHunt.Data.Entities.Area", b =>
                {
                    b.HasOne("ScannerKeyHunt.Data.Entities.Section", "Section")
                        .WithMany("Areas")
            ...
            modelBuilder.Entity("ScannerKeyHunt.Data.Entities.Block", b =>
                {
                    b.HasOne("ScannerKeyHunt.Data.Entities.Area", "Area")
                        .WithMany("Blocks")
            ...
            modelBuilder.Entity("ScannerKeyHunt.Data.Entities.Section", b =>
                {
                    b.HasOne("ScannerKeyHunt.Data.Entities.PuzzleWallet", "PuzzleWallet")
                        .WithMany("Sections")
                        .HasForeignKey("PuzzleWalletId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PuzzleWallet");
                });
